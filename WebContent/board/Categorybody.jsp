...
<%
	...
	try{
		...
		pstmt = conn.prepareStatement("SELECT ID, TITLE, CONTENT, IMAGE, CNCD, OUTCATEGORY FROM body_list WHERE CATEGORY ='" + category +"'");
		...
		while(rs.next()){
			...
			temp.put("bd_Content", rs.getString(3));
			temp.put("bd_ImageUrl", rs.getString(4));
			temp.put("bd_ConectCode", rs.getString(5));
			temp.put("bd_Category", rs.getString(6));
		...
		rootJson.put("cbdItem", childJson);

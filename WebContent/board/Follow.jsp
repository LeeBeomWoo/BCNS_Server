...
<%
	...
	try{
		...
		pstmt = conn.prepareStatement("SELECT ID, TITLE, CONTENT, IMAGE, CNCD FROM follow_list");
		...
		while(rs.next()){
			...
			temp.put("fm_Id", rs.getString(1));
			temp.put("fm_Title", rs.getString(2));
			temp.put("fm_Content", rs.getString(3));
			temp.put("fm_ImageUrl", rs.getString(4));
			temp.put("fm_ConectCode", rs.getString(5));

...
String table = request.getParameter("table");
	...
	try{
		...
		pstmt = conn.prepareStatement("SELECT  ID, TITLE, IMAGE, FACEIMAGE FROM trainer WHERE DATE > DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())+6 DAY) AND DATE <= DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-1 DAY)");
